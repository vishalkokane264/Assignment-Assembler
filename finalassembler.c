...
char *data=(char*)malloc(sizeof(char)+20);
  ...
  if(fp==NULL)
  {
    printf("assembly file opening error\n");
    exit(0); 
  }
  ...
  if(fp3==NULL)
  {
    printf("register file opening error\n");
    exit(0); 
  }
  ...
  n1=0;
//  for(i=0;i<25;i++)
//  printf("%d\t%s\t%s\n",i,regtab1[i].reg,regtab1[i].bval);
  n1=0;
        ...
        if(strcmp(t2,".data")==0)
        {
          ...
          while(fgets(buffer1,80,fp))
          {
            ...
            if((n1>2 ||n1==2) && (strcmp(t2,"dd")==0)||(strcmp(t1,"dd")==0))
            {
              ...
              table[lc].size=dd;
              table[lc].lineno=lc;
              sprintf(data,"%d\t%s\t%s\t",lc,table[lc].symname,table[lc].type);
              fprintf(fp2,"%s",data);
		strcpy(data,"\0");
//              printf("%d\t%s\t%s\t",lc,table[lc].symname,table[lc].type);
            ...
            if(n1>2 && strcmp(t2,"db")==0)
              ...
              fprintf(fp2,"%d\t%s\t%s\t%s",lc,table[lc].symname,table[lc].type,table[lc].data);
...
//              separatelitrals(t3,lc);
              ...
              if(strcmp(t1,"section")==0)
              {
                ...
                if((strcmp(t2,"dd")!=0)&&(strcmp(t2,"db")!=0)&&(strcmp(t2,"dq")!=0)&&(strcmp(t2,"dw")!=0))
                {
                  errtab1[lc].line=lc;
          ...
          while(fgets(buffer1,80,fp))
          {
            ...
            if (n1 == 3 && strcmp (t2, "resw") == 0)	//for labels
              ...
              if(strcmp(t1,"section")==0)
              {
                ...
                if((strcmp(t2,"resd")!=0)&&(strcmp(t2,"resq")!=0)&&(strcmp(t2,"resw")!=0)&&(strcmp(t2,"resb")!=0))
                {
                  fprintf(fp3,"line %d:Invalid opcode\n",lc);
                  sprintf(errmsg,"line %d:Invalid opcode\n",lc);
                  printf("%s",errmsg);
...
//                printf("%d\t%s\t%s\n",lc,oprand1[lc],oprand2[lc]);
                fprintf(fp2,"%d\t%s\t%s\t%s\n",lc,optab1[lc].opname,checkoprand(oprand1[lc],lc),checkoprand(oprand2[lc],lc));
                optab1[lc].line=lc;
              }   
...
fprintf(fp4,"lineno\tsymname\ttype\tsize\ttot_chr\tdef\tsorl\taddress\tsection\tdata\n");
for(i=1;i<=lc;i++)
{
...
{
//    if(littab1[i].line!=0)
//    printf("%d\t%s\t%s\n",littab1[i].line,littab1[i].litnamehex,littab1[i].litname);
}
flag=1; 
for(i=1;i<lc;i++)
{
...
int separatelitrals(char * str,int lc)
{
  int i;
  littab1[lc].line=lc;
//  printf("%d\t",littab1[lc].line);
  char *p=strtok(str,",");
